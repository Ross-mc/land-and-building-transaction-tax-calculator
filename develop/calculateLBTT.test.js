...
describe('Tests with various valid inputs', () => {
...
describe('Invalid user inputs', () => {
    test('User inputs a string of letters', () => {
        expect(calculateLBTT({
            propertyPrice: 'hello'
        })).toStrictEqual('Please Enter a Valid Number')
    })
    test('User enters muliple decimals', () => {
        expect(calculateLBTT({
            propertyPrice: '300,000.00.00'
        })).toStrictEqual('Please Enter a Valid Number')
    })
})
